...
const RAW = [
  ...
  ['create-core', "Create: Aeroworks", "Набор аддонов для Create: Aeronautics: гироскоп-стабилизатор, джойстик управления и другие блоки для пилотирования кораблей."],
  ['create-core', "Create Propulsion: Simulated", "Двигатели и тяга для кораблей Sable и Create: Aeronautics с корректной физикой момента, плюс copycat-крылья для лёгкой аэродинамики."],
  ['create-core', "Create Aeronautics: Toolgun", "Инструмент-пушка для быстрой сборки, копирования и редактирования воздушных контрапций."],
  ['create-core', "Create: Aeronautics Compat", "Слой совместимости Create: Aeronautics с другими модами сборки для корректной работы летающих конструкций."],
  ['create-core', "Create Hypertube", "Пневматические гипертрубы для скоростной транспортировки игроков и предметов между точками."],
  ['create-core', "Create Deep Seas", "Подводные суда на базе Create: Aeronautics — погружение и исследование морских глубин."],
  ['create-core', "Create: Trading Floor", "Торговый помост (Trading Depot) для автоматической торговли с жителями через механизмы Create."],
  ...
  ['create-rails', "Create: Radars", "Радары и системы обнаружения целей для контрапций, кораблей и обороны."],
  ['create-rails', "Create: Towed", "Буксировка мобов и животных к контрапциям Create: Aeronautics через физически симулируемые верёвки."],
  ['create-rails', "Create: Tracks", "Дополнительные рельсы для Create: Aeronautics в стиле Trackwork для движущихся конструкций."],
  ...
  ['create-deco', "Climbable Ropes", "Верёвки для Create: Aeronautics, по которым можно карабкаться вверх и вниз."],
  ...
  ['food', "Gensokyo Delight ~ Youkai's Feasts", "Японская кухня для Farmer's Delight: 140+ блюд, суши, напитки (чай, саке), новые культуры и посуда для готовки."],
  ...
  ['world', "BetterEnd", "Глобальная переработка Энда: десятки новых биомов, растений, материалов, мобов и построек в измерении Края."],
  ['world', "Yung's Better End Island", "Переработка центрального острова Энда и арены битвы с драконом: новая генерация, обелиски и сундуки с лутом."],
  ['world', "Better End Cities (Raijin)", "Новые, более детализированные структуры эндер-сити для генерации Края."],
  ['world', "Bigger Better End Cities", "Увеличенные и усложнённые эндер-сити для более интересного исследования Энда."],
  ...
  ['arch', "Vista — All The Cassettes", "Аддон к Vista: добавляет все кассеты с конкурса сообщества для просмотра гифок на экранах и телевизорах."],
  ...
  ['social', "Etched", "Кастомные музыкальные диски: запись, копирование и проигрывание собственной музыки через музыкальную шкатулку и проигрыватель."],
  ['social', "Genshin Instruments", "Играбельные музыкальные инструменты: барабаны, лиры и духовые для живых выступлений и совместной музыки."],
    ...
    <>
      <Head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "description": "Полный список модов сервера Гойдакрафт для Minecraft 1.21.1 NeoForge 21.1.233: Create, Create: Aeronautics, Steam 'n' Rails, Farmer's Delight, BetterEnd и другие.",
      ...
      <section className="blueprint">
        <div className="bp-header">
          <span className="label">Карта модов · Minecraft 1.21.1 / NeoForge 21.1.233</span>
