...
const RAW = [
  ...
  ['create-addons', "Create: Power Grid", "Аддон Create с электрической сетью: провода, столбы и накопители энергии, работающие совместно с кинетикой."],
  ['storage', "Create: Better Storage", "Аддон Create с улучшенными складскими блоками — ящиками и полками увеличенной вместимости, встроенными в логистику Create."],
