...
- Список модов, на которых держится сборка: **Create & Create: Aeronautics**, **Steam 'n' Rails**, **Farmer's Delight**, **Let's Do**, **Terralith + Rechiseled + Joy of Painting**.
...
- Полный каталог сборки: **113 модов** в **11 тематических категориях** (ядро Create, рельсы и орудия, декор Create, Let's Do, кухня Farmer's Delight, хранилища, генерация мира, архитектура, соц-моды, скриптовая магия, технические библиотеки).
...
- Два варианта сборки:
  - **GOIDAbase** — только обязательные моды, без которых нельзя зайти на сервер.
  - **GOIDAslon** — обязательные моды + оптимизация клиента.
- Два формата установки: ручной **ZIP**-архив и автоматический **.mrpack** (Modrinth/Prism и т.п.).
- Кнопка скачивания сборки (Google Drive).
- Сборка рассчитана на **Minecraft 1.21.1** / **NeoForge 21.1.233**.
